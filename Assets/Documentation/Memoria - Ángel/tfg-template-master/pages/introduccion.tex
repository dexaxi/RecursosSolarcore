...
\begin{compactitem}
    ...
    \item Esta interacción muestra un libro con información acerca del bioma y sus alteraciones.
    \item El jugador tendrá que completar un minijuego en el que relacione las alteraciones con sus posibles consecuencias para demostrar que ha entendido qué es lo que le está ocurriendo al bioma.
\end{compactitem}
Una vez el jugador haya demostrado que ha entendido todas las alteraciones de todos los biomas, el juego pasará a la segunda fase, la de restauración.
\begin{compactitem}
    \item Durante la fase de restauración, el jugador tendrá un presupuesto de energía para gastar en máquinas restauradoras.
    \item Cada bioma tendrá de 2-3 fases, cada una definida por una alteración distinta (Deforestación, Desertificación, Sobrepesca…)
...
Esta iniciativa nace a a raíz del Plan de Acción de Educación Digital 2021-2027 de la Comisión Europea, además de verse reforzada en España por los Reales Decretos 157/2022 y 217/2022, del 1 y 19 de marzo del 2022 respectivamente, que abogan por la inclusión del desarrollo del PC como competencia obligatoria a enseñar en las etapas de Educación Primaria y Secundaria Obligatoria.
