...
In the last years, Computational Thinking has gained traction as an indispensable ability for anyone today, much so that the majority of educational plans are starting to require it being teached at schools and highschools. This report contains the documentation of the development process for EcoRescue, an educational videogame which aims to aid with the development of Computational Thinking in students, teach about the environment and ecosystem restoration, as well as being an enjoyable and fun experience.
