...
El Pensamiento Computacional se define como una habilidad cognitiva que permite resolver problemas utilizando estrategias computacionales. 

En los últimos años el Pensamiento Computacional ha ganado tracción como una habilidad indispensable en la juventud de hoy en día, tanto así que la mayoría de planes educativos están comenzando a requerir que se enseñe en las aulas, de esta forma, esta memoria contiene la documentación del proceso de desarrollo de EcoRescue, un videojuego educativo que busca ayudar al desarrollo del Pensamiento Computacional en niños y adolescentes, divulgar acerca del medioambiente y la restauración de ecosistemas, y, sobre todo, ser una experiencia amena y divertida para el aula.
...
Computational Thinking is defined as a cognitive ability that allows the resolution of problems by the use of computational strategies.
